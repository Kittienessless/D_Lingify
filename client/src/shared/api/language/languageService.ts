...
export default class languageService {
  ...
  static async getLanguage(): Promise<AxiosResponse<ILanguage>> {
    return await $api.get<ILanguage>(`${BASE_URL}/lang/lang/:id`);
  }
  ...
  static async delete(key: string): Promise<AxiosResponse<ILanguage>> {
